...
button.addEventListener("click",function(){ VjezbeAjax.posaljiPodatke(form, (error,data)=>{
  ...
  if(error==null){
    ...
    alert("Pogresno ste unijeli broj zadataka, ponovite unos! "+ error);
...
var iscrtajVjezbe=function(odabirVjezbe,objekat){
  ...
  var brojZadataka1=objekat.brojZadataka;
   ...
   //ovdje sam stavila brojZadataka1[i] da bi pristupila podacima koliko zadataka ima u vjezbi tj.
   //npr imam vjezbu1 i u objektu brojzadataka mi je niz i prvi element tog niza je broj zadataka vjezbe1 itd...
